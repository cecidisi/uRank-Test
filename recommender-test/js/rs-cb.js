                ...
                Object.keys(_data).forEach(function(docId, i) {
                    ...
                    p.keywords.forEach(function(q) {
                        ...
                        if(d.keywords[q.stem]) {
                            var kwScore = ((parseFloat(d.keywords[q.stem]) / docNorm) * unitQueryVectorDot * parseFloat(q.weight));
                            kwDetails[q.term] = kwScore;
                            score += kwScore;
                        }
                    });
                    recs.push({ doc: docId, score: score, misc: { keywords: kwDetails } });
                });
            }
